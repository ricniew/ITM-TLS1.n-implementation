...
To get a picture about current agent connections (whether connected over "pipe" or "spipe") **or** to check agents after you performed and update to SPIPE, you can use the following commands. Go to a temporary folder and execute the commands below:
